            ...
            <section className="text-gray-400 bg-gray-900 body-font">
                <div className="container px-5 py-24 mx-auto flex flex-wrap">
                    <div className="flex w-full mb-20 flex-wrap">
                        ...
                        <p className="lg:pl-6 lg:w-2/3 mx-auto leading-relaxed text-lg">Sumérgete en la belleza y funcionalidad con nuestros elegantes muebles de lavamanos, diseñados para transformar tu espacio de baño en un oasis de comodidad y estilo.</p>
                    </div>
