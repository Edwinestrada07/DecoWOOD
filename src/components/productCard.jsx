                ...
                <div className="container px-5 py-24 mx-auto">
                    ...
                    <div className="flex flex-wrap sm:-m-4">
                        <div className="p-4 md:w-1/3 sm:mb-0 mb-6 hover:transform hover:translate-y-1 transition-transform duration-300">
                            ...
                            <p className="text-base leading-relaxed mt-2">Transformando hogares con estilo y funcionalidad. Descubre nuestras exclusivas 
                                colecciones de muebles y soluciones de diseño que convierten cada espacio en un verdadero reflejo de tu personalidad y comodidad.</p>                           
                        </div>
                        ...
                        <div className="p-4 md:w-1/3 sm:mb-0 mb-6 hover:transform hover:translate-y-1 transition-transform duration-300">
                            ...
                            <p className="text-base leading-relaxed mt-2">Innovación, calidad y belleza se unen en cada uno de nuestros productos. 
                                Desde cocinas hasta muebles de lavandería, nuestra empresa ofrece soluciones integrales para el hogar, diseñadas para 
                                satisfacer las necesidades más exigentes con un toque de elegancia incomparable.
                            </p>
                        </div>
                        ...
                        <div className="p-4 md:w-1/3 sm:mb-0 mb-6 hover:transform hover:translate-y-1 transition-transform duration-300">
                            ...
                            <p className="text-base leading-relaxed mt-2">Creando ambientes excepcionales para vivir y disfrutar. 
                                Con una amplia gama de muebles y accesorios para cada rincón del hogar, nuestra empresa se destaca por 
                                ofrecer diseño innovador, materiales de primera calidad y atención al detalle en cada pieza.
                            </p>
                        </div>
                    </div>
                </div>
